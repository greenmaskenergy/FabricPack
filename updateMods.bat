...
echo by GreenMaskEnergy [90mversion 2.4.1[0m 
echo.
echo.
...
echo =============================================================================
echo.
echo this downloader is currently located at:
echo.
set "RawPath=%~dp0"
...
if %Parent% == mods (
    ...
    echo.
    echo [91mWrong directory this downloader needs to be placed in the "/mod" Folder[0m
    echo.
    echo.
...
bitsadmin.exe /transfer "" /priority FOREGROUND https://onehit.eu/MC_ModLists/FabricPack/mods "%RawPath%/mods"
echo. >> "%log%"
